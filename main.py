...
def quest_menu():
    ...
    try:
        ...
        quest_choice = int(input('What would you like to do?: '))
        if quest_choice == 1:
...
def save_game():
    ...
    try:
        character_manager.save_character(current_character,1)
    except Exception as e:
        print(e)
